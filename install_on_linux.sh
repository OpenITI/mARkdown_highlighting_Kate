...
cp SCHEME_FILES/OpenITImARkdown.xml "$HOME/.local/share/org.kde.syntax-highlighting/syntax/"
cp SCHEME_FILES/OpenITImARkdown_EIS1600.xml "$HOME/.local/share/org.kde.syntax-highlighting/syntax/"
